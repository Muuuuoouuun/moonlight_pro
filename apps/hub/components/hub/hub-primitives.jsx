...
export function Button({ children, variant = 'ghost', size = 'sm', icon, iconRight, style, onClick, active, type = 'button', className, disabled = false, ...rest }) {
  const sizes = {
...
export function Checkbox({ checked, onChange, size = 14, label, disabled = false, 'aria-busy': ariaBusy = false }) {
  return (
    <button
      type="button"
      role="checkbox"
