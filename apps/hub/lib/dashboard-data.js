...
export const navigationItems = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        i18nKey: "workRhythm",
        label: "리듬",
        description: "주기 점검과 반복 운영 루프",
      },
      {
        href: "/dashboard/work/pms",
        i18nKey: "workPms",
        label: "PMS",
        description: "GitHub 출하 박동과 운영자 리듬",
      },
      {
        href: "/dashboard/work/roadmap",
        i18nKey: "workRoadmap",
        label: "로드맵",
        description: "마일스톤, 릴리즈 레인, 전달 리스크",
      },
      {
      ...
      },
      {
        ...
        label: "의사결정",
        description: "판단, 리뷰 노트, 후속 실행",
      },
      {
        href: "/dashboard/work/releases",
        i18nKey: "workReleases",
        label: "릴리즈",
        description: "패치 노트와 주간 출하 로그",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    i18nKey: "dailyBrief",
    label: "데일리 브리프",
    description: "아침 브리프, 승인 대기, 다음 세 가지 액션",
    group: "utility",
  },
  {
  ...
  },
  {
    ...
    i18nKey: "command",
    label: "커맨드",
    description: "한 팔레트에서 검색, 라우팅, 작업 디스패치",
    group: "utility",
  },
  {
    ...
    i18nKey: "operations",
    label: "운영",
    description: "AI 디스패치, 자동화 상태, 액션 허브",
    group: "utility",
  },
  {
    href: "/dashboard/ai",
    i18nKey: "ai",
    label: "AI",
    description: "에이전트를 호출하고 작업을 던지며 운영 플로어를 본다",
    group: "utility",
    children: [
      {
        href: "/dashboard/ai",
        i18nKey: "aiOverview",
        label: "개요",
        description: "에이전트 현황, 빠른 디스패치, 오피스 박동",
      },
      {
        href: "/dashboard/ai/chat",
        i18nKey: "aiChat",
        label: "스레드",
        description: "재사용 가능한 스레드와 직접 메시지",
      },
      {
        href: "/dashboard/ai/council",
        i18nKey: "aiCouncil",
        label: "카운슬",
        description: "Claude와 Codex가 검토하고 토론하고 수렴",
      },
      {
        href: "/dashboard/ai/orders",
        i18nKey: "aiOrders",
        label: "오더",
        description: "직접 지시, 작업 생성, 실행 추적",
      },
    ],
  },
  {
...
export const summaryStats = [
  {
    title: "진행 프로젝트",
    value: "06",
    detail: "다음 작업 블록 전에 2개는 마일스톤 정리가 필요합니다.",
    badge: "실행",
  },
  {
    title: "PMS 점검",
    value: "03",
    detail: "아침, 점심, 주간 리뷰 레인이 보이도록 정리했습니다.",
    badge: "리듬",
    tone: "muted",
  },
  {
    title: "활성 리드",
    value: "18",
    detail: "그중 3개는 바로 후속 대응할 수 있는 온도입니다.",
    badge: "세일즈",
    tone: "warning",
  },
  {
    title: "웹훅 상태",
    value: "02/03",
    detail: "텔레그램과 헬스 엔드포인트는 살아 있고 프로젝트 인입도 준비됐습니다.",
    badge: "엔진",
    tone: "blue",
  },
  {
...
export const todayFocus = [
  {
    title: "프로젝트 레인을 앞으로 밀기",
    detail: "우선순위가 가장 높은 프로젝트의 마일스톤을 올리고 다음 블로커를 적습니다.",
  },
  {
    title: "PMS 체크포인트 실행",
    detail: "맥락이 흩어지기 전에 리듬 점검 한 번으로 하루의 중심을 잡습니다.",
  },
  {
    title: "프로젝트 웹훅 인입 검증",
    detail: "외부 도구를 연결하기 전에 엔진이 진행 이벤트를 받을 수 있는지 확인합니다.",
  },
];
...
export const systemChecks = [
  {
    title: "허브 셸",
    value: "온라인",
    detail: "대시보드, 프로젝트, PMS, 자동화, 로그 레인이 모두 보입니다.",
  },
  {
    title: "프로젝트 진행",
    value: "추적 중",
    detail: "마일스톤, 블로커, 다음 액션을 한 운영 화면에서 볼 수 있습니다.",
  },
  {
    title: "PMS 리듬",
    value: "준비됨",
    detail: "일간/주간 리듬 블록이 암묵적이 아니라 명시적으로 보입니다.",
  },
  {
    title: "웹훅 인입",
    value: "준비 완료",
    detail: "텔레그램과 프로젝트 진행 엔드포인트가 엔진 경로에 연결돼 있습니다.",
  },
];
...
export const activityFeed = [
  {
    title: "프로젝트 레인 확장",
    detail: "진행률, 마일스톤, 프로젝트 업데이트 리듬이 허브에 들어왔습니다.",
    time: "방금",
  },
  {
    title: "PMS 리듬 가시화",
    detail: "아침 박동, 주간 리뷰, 후속 노트가 자리 잡았습니다.",
    time: "8분 전",
  },
  {
    title: "웹훅 점검 경로 추가",
    detail: "엔진이 프로젝트 진행 인입과 서비스 상태용 경로를 노출합니다.",
    time: "14분 전",
  },
];
...
export const projectUpdates = [
  {
    title: "Hub OS 활성화가 구현 단계로 이동",
    detail: "셸에서 프로젝트, PMS, 자동화 운영 화면이 노출되기 시작했습니다.",
    time: "지금",
    tone: "green",
  },
  {
    title: "프로젝트 웹훅 라우트 준비",
    detail: "엔진 인입 경로가 들어오는 진행 이벤트를 정규화하고 요약할 수 있습니다.",
    time: "다음",
    tone: "blue",
  },
  {
    title: "실데이터 연결은 아직 대기",
    detail: "다음 마일스톤은 정적 시드 데이터를 저장소 기반 조회로 교체하는 일입니다.",
    time: "예정",
    tone: "warning",
  },
];
...
export const quickCommands = [
  {
    ...
    note: "엔진 경로를 통해 카드뉴스 초안을 생성합니다.",
  },
  {
    command: "/projects",
    note: "다음에 움직여야 할 프로젝트 레인을 엔진에게 묻습니다.",
  },
  {
    command: "/pms weekly",
    note: "다음 리듬 블록이나 리뷰 체크포인트를 불러옵니다.",
  },
  {
    command: "/webhooks",
    note: "사용 가능한 웹훅 엔드포인트와 헬스 체크를 점검합니다.",
  },
];
...
export const commandCenterQueue = [
  {
    title: "프로젝트 마일스톤 갱신",
    detail: "상위 2개 활성 프로젝트에 블로커와 다음 액션 노트를 업데이트합니다.",
    tone: "green",
  },
  {
    title: "PMS 점심 체크",
    detail: "하루가 반응형 작업으로 흩어지기 전에 두 번째 리듬 점검을 실행합니다.",
    tone: "warning",
  },
  {
    title: "웹훅 스모크 테스트",
    detail: "샘플 프로젝트 진행 payload 하나를 엔진 라우트로 보냅니다.",
    tone: "blue",
  },
];
...
export const aiAgents = [
  {
    ...
    queueDepth: 2,
    lastActiveAt: "방금",
    currentTaskTitle: "Agent 홈 구조와 카피 정리",
    workspace: "War room",
    visualToken: "planner",
    specialties: ["전략 정리", "리뷰", "카피 톤"],
    lastShip: "AI 홈 IA 초안",
  },
  {
    id: "codex",
    ...
    queueDepth: 3,
    lastActiveAt: "3분 전",
    currentTaskTitle: "Agent 첫 화면 구현",
    workspace: "Build bay",
    visualToken: "builder",
    specialties: ["구현", "리팩터", "QA 후속 수정"],
    lastShip: "웹훅 분기 리팩터",
  },
  {
    id: "engine",
    ...
    queueDepth: 1,
    lastActiveAt: "4분 전",
    currentTaskTitle: "자동화 큐 비우기",
    workspace: "Automation dock",
    visualToken: "ops",
    specialties: ["자동화 실행", "큐 처리", "런 상태 보고"],
    lastShip: "실패 알림 라우트 안정화",
  },
];

export const aiRecentRecalls = [
  {
    id: "recall-claude-agent-home",
    agentId: "claude",
    title: "Agent 탭 제품 스펙 정리",
    reason: "첫 화면을 지휘형 홈으로 바꾸기 전 JTBD와 IA를 고정",
    requestedAt: "방금",
    sourceType: "manual",
    status: "진행 중",
  },
  {
    id: "recall-codex-agent-home",
    agentId: "codex",
    title: "Agent 첫 화면 UI 구현",
    reason: "로스터, 빠른 오더, 오피스 맵을 실제 화면으로 연결",
    requestedAt: "3분 전",
    sourceType: "order",
    status: "실행 중",
  },
  {
    id: "recall-engine-ops",
    agentId: "engine",
    title: "자동화 큐 상태 재확인",
    reason: "콘텐츠 런 큐 대기를 줄이기 위한 실시간 확인",
    requestedAt: "11분 전",
    sourceType: "chat",
    status: "완료",
  },
...
export const aiQuickOrderTemplates = [
  {
    id: "quick-research",
    title: "리서치 정리 시키기",
    target: "Claude",
    prompt: "현재 문맥을 읽고 핵심 인사이트 5개와 다음 액션 3개로 정리",
    defaultPriority: "P1",
    defaultLane: "Strategy",
    shortcut: "/recall claude",
    lastUsedAt: "오늘",
  },
  {
    id: "quick-implement",
    title: "명세대로 구현 시키기",
    target: "Codex",
    prompt: "현재 레포 기준으로 최소 diff로 구현하고 검증 결과까지 남기기",
    defaultPriority: "P1",
    defaultLane: "Build",
    shortcut: "/order codex",
    lastUsedAt: "방금",
  },
  {
    id: "quick-council",
    title: "둘이 비교 검토 시키기",
    target: "Claude + Codex",
    prompt: "하나의 주제에 대해 전략안과 구현안을 부딪혀 한 결론으로 수렴",
    defaultPriority: "P2",
    defaultLane: "Council",
    shortcut: "/council",
    lastUsedAt: "어제",
  ...
  zones: [
    {
      ...
      label: "War room",
      tone: "blue",
      description: "계획, 우선순위, 리뷰가 모이는 자리",
      occupiedAgentIds: ["claude"],
    },
    {
      id: "zone-build-bay",
      label: "Build bay",
      tone: "warning",
      description: "실제 구현과 수정이 돌아가는 작업대",
      occupiedAgentIds: ["codex"],
    },
    {
      id: "zone-automation-dock",
      label: "Automation dock",
      tone: "green",
      description: "실행 런과 큐가 흐르는 자동화 선착장",
      occupiedAgentIds: ["engine"],
    },
  ],
};

export const aiWorkloadSignals = {
  activeCount: 3,
  queuedCount: 2,
  blockedCount: 0,
  idleCount: 0,
  hotAgentIds: ["codex"],
  overloadedAgentIds: [],
  summaryChips: ["Recall-first", "Office live", "3 reusable threads"],
};
