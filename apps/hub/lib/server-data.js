...
import {
  ...
  aiOfficeLayout as fallbackAiOfficeLayout,
  aiOpenOrders as fallbackAiOpenOrders,
  aiOrderTemplates as fallbackAiOrderTemplates,
  aiOsPulse as fallbackAiOsPulse,
  aiQuickOrderTemplates as fallbackAiQuickOrderTemplates,
  aiRecentRecalls as fallbackAiRecentRecalls,
  aiWorkloadSignals as fallbackAiWorkloadSignals,
...
export async function getAiConsolePageData() {
  return {
    ...
    officeLayout: fallbackAiOfficeLayout,
    openOrders: fallbackAiOpenOrders,
    orderTemplates: fallbackAiOrderTemplates,
    osPulse: fallbackAiOsPulse,
    quickOrderTemplates: fallbackAiQuickOrderTemplates,
    recentRecalls: fallbackAiRecentRecalls,
    workloadSignals: fallbackAiWorkloadSignals,
  };
}
