...
function request(headers = {}) {
  return new Request("https://hub.test/api/cron/content-flywheel", { headers });
}

test("authenticated legacy execution returns 410 and directs requests to Studio", async () => {
  ...
  assert.match(body.message, /Studio/);
