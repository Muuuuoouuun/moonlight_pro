...
export const metadata = {
  ...
  description: "Data deletion instructions for Moonlight social and YouTube connections.",
};
    ...
    <main style={{
      ...
      <article style={{
        ...
        <p style={{ margin: 0, color: "var(--muted)", lineHeight: 1.7 }}>
          To delete data associated with a connected Moonlight integration,
        ...
        <section style={{
          ...
          <p style={{ margin: 0, color: "var(--muted)", fontSize: 14, lineHeight: 1.65 }}>
            ...
            integration data and does not delete content or account records held by
            Google, YouTube, or Meta.
          </p>
        </section>
      </article>
    </main>
