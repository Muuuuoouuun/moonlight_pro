...
import { defaultLocale, isLocale, LOCALE_COOKIE } from "./config.js";

/**
 * next-intl request configuration for the Hub.
 *
 ...
 *
 * Wired into Next via `createNextIntlPlugin("./i18n/request.js")` in
 * `next.config.mjs`.
 */
