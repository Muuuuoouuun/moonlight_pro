...
export const DEFAULT_SALES_KNOWLEDGE: KnowledgeDirective = {
  ...
  playbooks: [
    ...
    'Dick Dunkel / Aaron Ross MEDDIC 자격 요건: Economic Buyer(진짜 예산 권한자) 직접 접촉 및 Decision Process/Criteria 확인.',
  ...
  rules: [
    ...
    '거장의 실전 팁 인터리빙: 1단계 행동 끝에 30초 내 적용 가능한 원 포인트 팁 1개(💡 [실전 팁]: ...) 첨부 (카네기 Feel-Felt-Found/이름 3번, 힐 미팅 전 5분 시각화, 보스 심야 DJ 톤, 키넌 결함비용 역계산 등)',
  ],
  forbidden: [
...
export const DEFAULT_BRAND_KNOWLEDGE: KnowledgeDirective = {
  ...
  playbooks: [
    'Seth Godin SVM (가장 작은 실행 가능한 시장): 단 10명의 열광자를 찾고, 그들이 친구에게 공유하지 않고는 못 배길 단 하나의 문장을 벼린다. 대중을 겨냥한 두루뭉술한 조언은 쓰레기통에 버린다.',
    'David Ogilvy 팩트 기반 카피라이팅: 헤드라인이 전체의 80%를 결정한다. 형용사나 미사여구를 모두 지우고, 구체적 숫자·관찰된 사실·명확한 증거로만 독자의 시선을 멈춘다.',
  ...
  rules: [
    ...
    '거장의 실전 팁 인터리빙: 1단계 행동 끝에 30초 내 적용 가능한 원 포인트 팁 1개(💡 [실전 팁]: ...) 첨부 (고딘 10인 카톡 코멘트, 오길비 팩트 헤드라인, 골드랫 배치 크기 1개 축소 등)',
  ],
  forbidden: [
