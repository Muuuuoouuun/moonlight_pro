...
const prefix='/tmp/moonlight-office-source-enum-check';
...
await officeQualityCli({live:true,only:['vaporeon-evidence','jolteon-evidence','glaceon-social'],output:prefix+'.run.jsonl','dataset-status':'development',concurrency:'1'}, {generate:generateOfficeResponse,generateProvider});
