...
const prefix='/tmp/moonlight-office-policy-source-check';
...
await officeQualityCli({live:true,only:['vaporeon-evidence'],output:prefix+'.run.jsonl','dataset-status':'development',concurrency:'1'}, {generate:generateOfficeResponse,generateProvider});
