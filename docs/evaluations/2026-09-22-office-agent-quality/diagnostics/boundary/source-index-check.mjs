...
const prefix='/tmp/moonlight-office-source-index-check';
...
await officeQualityCli({live:true,only:['vaporeon-evidence','jolteon-evidence','glaceon-social','delivery-urgent'],output:prefix+'.run.jsonl','dataset-status':'development',concurrency:'1'}, {generate:generateOfficeResponse,generateProvider});
