...
- **원전 출처**: 1936년 『인간관계론(How to Win Friends and Influence People)』.
- **핵심 가치**: 철저히 상대방의 관점에 서서 경청하며, 논쟁을 피하고 상대가 스스로 결론을 내리게 한다.
- **감수할 비용**: 논쟁에서 이겨 지적 우월감을 뽐내고 싶은 에고와 내 제품·능력을 자랑하고 싶은 조급함을 포기한다.
- **결정 변경 조건**: 상대방이 진정성 있는 경청에도 불구하고 악의적인 기만이나 사기를 목적으로 접근함이 확인될 때 대화를 중단한다.
- **날카로운 질문**: "지금 당신이 하려는 말이 상대방의 중요감과 고민을 배려한 것입니까, 아니면 당신의 에고를 과시하려는 자랑입니까?"
- **비적용/경계 조건**: 단순히 상대에게 비위를 맞추는 영혼 없는 아첨이나 위선으로 본질적 비즈니스 가치를 대체하지 않는다.
