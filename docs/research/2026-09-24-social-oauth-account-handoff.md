...
| YouTube 개인 3채널 | `moonlight-youtube-509603`의 Data API v3·읽기/업로드 범위·테스트 사용자 3명·웹 OAuth 클라이언트 설정 완료. `기독밈`(`UCb599DDZuNpGXdasHgqKkzw`), `문군`(`UCJ6W-afKFqwgL_h09S3K83Q`), `22세기 유목민`(`UCK_CYxp_L_BiM2GCcP4r_8w`) 각각 Hub `connected`·갱신 토큰 확인 | Testing 갱신 토큰은 각각 2026-10-01 07:17, 07:16, 05:55 UTC 만료 예정. 장기 OAuth 운영 조건 검토 |
