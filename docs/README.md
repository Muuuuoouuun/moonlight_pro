...
- [`superpowers/specs/2026-09-23-project-direct-workflow-redesign.md`](superpowers/specs/2026-09-23-project-direct-workflow-redesign.md) — **DRAFT · 2026-09-23 재기획, 미구현**. 프로젝트에 직접 할 일을 한 줄로 만들고 체크하는 경로를 기본으로, 마일스톤·작업 묶음을 선택 사항으로 내리는 제안. 비대한 완료 계획은 점진 노출하고, 기존 완료 검증을 완화하는 안은 별도 결정으로 분리한다. 아래 09-23 개요 스펙의 하위 항목 우선 가설을 재검토한다.
