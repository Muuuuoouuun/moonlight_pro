...
- [`superpowers/specs/2026-09-23-project-operator-experience-and-write-trust-design.md`](superpowers/specs/2026-09-23-project-operator-experience-and-write-trust-design.md) — **DRAFT · 평가/권장, 구현 승인 아님**. 실제 프로젝트 개요의 다음 행동·진척 근거·모바일 우선순위·보관 영향과 저장 재시도의 멱등성 계약을 사용자/PO 관점에서 정리한다. 기존 완료 검증·PMS 저장 모델은 유지한다.
