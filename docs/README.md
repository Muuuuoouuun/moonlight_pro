...
- Guru 도움 카드: [하루 세 번·상황 적합성·출처 품질](superpowers/specs/2026-09-24-guru-three-slot-context-quality-design.md)이 일간 한 장 선정을 서울 09·14·19시의 세 구간으로 대체한다(시각은 시범 기본값). [첫 시범 설계](superpowers/specs/2026-09-24-guru-guidance-cards-design.md)의 요청형 조언과 [멘토 서가·조용한 레일](superpowers/specs/2026-09-24-guru-dual-experience-design.md)의 위치·무알림 원칙은 유지한다. 출처를 검토한 분야별 카드 5장과 [참고 자료 품질 점검](research/2026-09-24-guru-source-quality.md)만 선별해 연결한다. 격리 개발 서버에서 실사용 확인 후 운영 적용은 별도다. 홈·오늘 승인 대기·Studio 본문에는 카드를 넣지 않고, 카드 열람으로 업무를 생성하지 않는다.
