...
- [`superpowers/specs/2026-09-13-codex-mcp-api-integration-design.md`](superpowers/specs/2026-09-13-codex-mcp-api-integration-design.md) — **DRAFT · 설계 제안**. 기존 13개 MCP 도구를 기반으로 Codex 양방향 연결, 공통 Agent API, 작은 조회 응답, 멱등 명령·충돌 제어, SDK worker와 진행·중단·재개, 토큰·지연 측정 기준을 설계한다. 9월 4일 MCP 제안을 구체화하며 원격 배포·구현 완료를 뜻하지 않는다.
