...
| 회의 텍스트 검토 M0 | 코드 구현·로컬 테스트 통과 / 운영 DB·배포·실사용 검증 전 | 저장된 메모에서 전사 TXT 가져오기, 수동 분석, 근거 후보 확인·수정·제외, 확인한 행동의 할 일 연결과 영수증 재조회. 새 0045 migration은 서울 운영 DB에 미적용. 직접 녹음·30일 원본 삭제·월 비용·CRM/Office/MCP 배분은 M1~M3. [구현·검증 기록](superpowers/plans/2026-09-23-meeting-text-review-m0.md) |
