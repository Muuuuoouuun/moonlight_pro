import type { OfficeId, OfficeMode } from './office.js';
...
export type OfficeWorkflowResult = OfficeWorkflowMeta & ((OfficeWorkflowAnswer & {status:'generated';resultRevision:1;context:{asOf:string;contextHash:string;missing:string[]};generation:OfficeWorkflowGeneration})|{status:'preview'|'error';error:string});
