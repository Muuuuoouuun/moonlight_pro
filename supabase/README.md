...
- `apply-pending.sql`: **편의 번들** — 0003→0011 + 0019~0020을 시점순으로 묶은 단일 파일(멱등). 대시보드 SQL Editor에 한 번에 붙여넣기용. 정본은 위 개별 migration 파일.
